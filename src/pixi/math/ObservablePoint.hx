...
extern class ObservablePoint implements IPoint {
	 ...
	 * where x represents the position on the horizontal axis and y represents the position on the vertical axis.
	 * 
	 ...
	 */
	function new(cb:Any->Any, scope:Any, x:Float = 0, y:Float = 0);
	 ...
	 */
	 ...
	 /**
	  * Creates a clone of this point. The callback and scope params can be overridden otherwise 
	  * they will default to the clone object's values.
	  * 
	  * @return A clone of this point
	  */
	 function clone(cb:Any->Any, scope:Any):ObservablePoint;
	  ...
	  */
	 function copyFrom(p:IPointData):ObservablePoint;
	  ...
	  * @return Returns itself
	  */
	 function set(?x:Float, ?y:Float):ObservablePoint;
